...
class Linker {
    constructor(opts) {
        ...
        this.bases = (_a = opts.bases, (_a !== null && _a !== void 0 ? _a : [])).map((path) => path_1.resolve(path));
        this.excludes = new Set((_b = opts.excludes, (_b !== null && _b !== void 0 ? _b : [])).map((path) => path_1.resolve(path)));
        this.external_modules = new Set((_c = opts.externals, (_c !== null && _c !== void 0 ? _c : [])).filter((s) => typeof s === "string"));
        this.external_regex = (_d = opts.externals, (_d !== null && _d !== void 0 ? _d : [])).filter((s) => s instanceof RegExp);
        this.excluded = (_e = opts.excluded, (_e !== null && _e !== void 0 ? _e : (() => false)));
        this.builtins = (_f = opts.builtins, (_f !== null && _f !== void 0 ? _f : false));
        this.exports = new Set((_g = opts.exports, (_g !== null && _g !== void 0 ? _g : [])));
        this.prelude = (_h = opts.prelude, (_h !== null && _h !== void 0 ? _h : null));
        if (this.builtins) {
        ...
        this.shims = new Set((_j = opts.shims, (_j !== null && _j !== void 0 ? _j : [])));
    }
    is_external(dep) {
        ...
        const [base, base_path, canonical, resolution] = (() => {
            ...
            for (const base of secondary) {
                ...
                if (!path.startsWith("..")) {
                    ...
                    const entry = (_a = pkg.module, (_a !== null && _a !== void 0 ? _a : pkg.name));
                    const primary = path_1.join(dir, entry) == path_1.join(base, path);
