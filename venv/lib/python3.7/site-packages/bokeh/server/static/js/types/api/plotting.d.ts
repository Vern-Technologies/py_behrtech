...
export declare type FigureAttrs = Omit<Plot.Attrs, "x_range" | "y_range"> & {
...
export declare function figure(attributes?: Partial<FigureAttrs>): Figure;
export declare function show(obj: LayoutDOM, target?: HTMLElement | string): Promise<ViewOf<LayoutDOM>>;
export declare function show(obj: LayoutDOM[], target?: HTMLElement | string): Promise<ViewOf<LayoutDOM>[]>;
